...
echo "discovery.zen.ping.unicast.hosts: ["$esmasternode1","$esmasternode2","$esdatanode1","$esdatanode3"]" >>/etc/elasticsearch/elasticsearch.yml 
...
case ${HOSTNAME} in
     esmasternode1|esmasternode2)
           echo "Running Master Node Function"
           MasterNodeFunc
           ;;
    esdatanode1|esdatanode3)
